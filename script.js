const translations = {
  pl: {
    ...
    stay: { kicker: "Twój pobyt", title: "W sam raz na wspólny wyjazd.", text: "Apartament zawiera klimatyzację, dwie sypialnie — jedną z łóżkiem podwójnym, drugą z dwoma pojedynczymi łóżkami — a także część dzienną z jadalnią, kompaktową kuchnię, dwie łazienki — w tym jedną z prysznicem i pralką — oraz balkon.", note: "Szczegóły wyposażenia i warunków pobytu potwierdzimy przy zapytaniu.", cta: "Sprawdź dostępność" },
    booking: {
    ...
    pricing: { title: "Szacunkowy koszt pobytu", selectDates: "Wybierz datę przyjazdu i wyjazdu, aby zobaczyć kalkulację.", nights: "Liczba nocy", accommodation: "Pobyt", discount: "Rabat za dłuższy pobyt", cleaning: "Przygotowanie apartamentu", total: "Razem orientacyjnie", note: "To niewiążąca kalkulacja. Ostateczną cenę, ewentualne opłaty lokalne i warunki pobytu potwierdzi właściciel przy akceptacji zapytania." },
    ...
    faq: { kicker: "Najczęstsze pytania", title: "Warto wiedzieć przed przyjazdem.", intro: "Najważniejsze informacje o apartamencie, zapytaniu i potwierdzeniu pobytu.", q1: "Dla ilu osób jest apartament?", a1: "Apartament jest przeznaczony dla maksymalnie 4 gości.", q2: "Jaki jest układ apartamentu?", a2: "Do dyspozycji są dwie sypialnie — jedna z łóżkiem podwójnym i druga z dwoma pojedynczymi łóżkami — część dzienna z jadalnią, kompaktowa kuchnia, dwie łazienki oraz balkon.", q3: "Jak potwierdzana jest rezerwacja?", a3: "Po wybraniu dat i liczby gości wysyłasz zapytanie. Pobyt jest potwierdzony dopiero po jego zaakceptowaniu przez właściciela.", q4: "Czy wysłanie zapytania blokuje termin?", a4: "Nie. Termin zostaje zablokowany dopiero po zaakceptowaniu zapytania; wcześniej pozostaje dostępny dla innych osób.", q5: "Kiedy otrzymam dokładny adres?", a5: "Dokładną lokalizację w Falerna Marina i wskazówki dojazdu przekazujemy po potwierdzeniu pobytu.", q6: "Jak można się skontaktować?", a6: "Możesz wysłać formularz, napisać e-mail lub skorzystać z WhatsApp. W wiadomości warto podać daty i liczbę gości." },
  ...
  en: {
    ...
    pricing: { title: "Estimated stay price", selectDates: "Choose check-in and check-out dates to see an estimate.", nights: "Nights", accommodation: "Accommodation", discount: "Long-stay discount", cleaning: "Apartment preparation", total: "Estimated total", note: "This is a non-binding estimate. The owner confirms the final price, any local charges and stay conditions when accepting the enquiry." },
    ...
    faq: { kicker: "Frequently asked questions", title: "Good to know before you arrive.", intro: "The essentials about the apartment, enquiries and confirming your stay.", q1: "How many guests can the apartment accommodate?", a1: "The apartment accommodates a maximum of 4 guests.", q2: "What is the apartment layout?", a2: "There are two bedrooms — one with a double bed and one with two single beds — a living and dining area, compact kitchen, two bathrooms and a balcony.", q3: "How is a booking confirmed?", a3: "Choose your dates and number of guests, then send an enquiry. Your stay is confirmed only after the owner accepts it.", q4: "Does an enquiry block the dates?", a4: "No. Dates are blocked only after the enquiry is accepted; until then, they remain available to other guests.", q5: "When will I receive the exact address?", a5: "We share the exact location in Falerna Marina and arrival directions after your stay is confirmed.", q6: "How can I get in touch?", a6: "You can use the enquiry form, send an e-mail or message us on WhatsApp. It helps to include your dates and number of guests." },
  ...
  it: {
    ...
    pricing: { title: "Costo stimato del soggiorno", selectDates: "Scegli arrivo e partenza per visualizzare la stima.", nights: "Notti", accommodation: "Soggiorno", discount: "Sconto soggiorno lungo", cleaning: "Preparazione appartamento", total: "Totale indicativo", note: "La stima non è vincolante. Il proprietario confermerà il prezzo finale, gli eventuali oneri locali e le condizioni al momento dell’accettazione." },
    ...
    faq: { kicker: "Domande frequenti", title: "Cosa sapere prima dell’arrivo.", intro: "Le informazioni essenziali sull’appartamento, la richiesta e la conferma del soggiorno.", q1: "Quanti ospiti può accogliere l’appartamento?", a1: "L’appartamento può accogliere un massimo di 4 ospiti.", q2: "Com’è organizzato l’appartamento?", a2: "Sono disponibili due camere — una con letto matrimoniale e una con due letti singoli — zona giorno con pranzo, cucina compatta, due bagni e balcone.", q3: "Come viene confermata la prenotazione?", a3: "Scegli le date e il numero di ospiti, quindi invia una richiesta. Il soggiorno è confermato solo dopo l’accettazione del proprietario.", q4: "L’invio di una richiesta blocca le date?", a4: "No. Le date vengono bloccate soltanto dopo l’accettazione della richiesta; prima restano disponibili per altri ospiti.", q5: "Quando riceverò l’indirizzo esatto?", a5: "Comunichiamo la posizione esatta a Falerna Marina e le indicazioni per l’arrivo dopo la conferma del soggiorno.", q6: "Come posso contattarvi?", a6: "Puoi usare il modulo, inviare un’e-mail o scriverci su WhatsApp. Indica preferibilmente le date e il numero di ospiti." },
    ...
    alt: { hero: "Balcone dell’appartamento con vista sul Mar Tirreno", interior: "Soggiorno e sala da pranzo con accesso al balcone", sea: "Sala da pranzo dell’appartamento Mare Lento", livingDining: "Soggiorno e sala da pranzo con accesso al balcone", doubleBedroom: "Camera matrimoniale con accesso al balcone", twinBedroom: "Camera con due letti singoli", bathroom: "Uno dei due bagni dell’appartamento, con box doccia e bidet", regionGallery1: "Vista dalla terrazza sulla costa turchese della Calabria", regionGallery2: "Vista sulla costa dal belvedere di Capo Vaticano", regionGallery3: "Panorama di Pizzo Calabro e della costa tirrenica turchese", regionGallery4: "Onde che si infrangono contro una grotta rocciosa sulla costa calabrese", regionGallery5: "Santuario di Santa Maria dell’Isola sul promontorio roccioso di Tropea" }
  },
  de: {
    ...
    stay: { kicker: "Ihr Aufenthalt", title: "Wie gemacht für eine gemeinsame Auszeit.", text: "Das Apartment verfügt über eine Klimaanlage, zwei Schlafzimmer — eines mit Doppelbett und eines mit zwei Einzelbetten — sowie einen Wohn- und Essbereich, eine kompakte Küche, zwei Badezimmer — eines davon mit Dusche und Waschmaschine — und einen Balkon.", note: "Details zur Ausstattung und zu den Aufenthaltsbedingungen bestätigen wir mit Ihrer Anfrage.", cta: "Verfügbarkeit prüfen" },
    ...
    pricing: { title: "Geschätzter Aufenthaltspreis", selectDates: "Wählen Sie An- und Abreise, um die Schätzung anzuzeigen.", nights: "Nächte", accommodation: "Aufenthalt", discount: "Langzeitrabatt", cleaning: "Vorbereitung des Apartments", total: "Voraussichtlicher Gesamtpreis", note: "Diese Schätzung ist unverbindlich. Den Endpreis, mögliche lokale Abgaben und die Aufenthaltsbedingungen bestätigt der Eigentümer bei Annahme der Anfrage." },
    ...
    faq: { kicker: "Häufige Fragen", title: "Gut zu wissen vor der Anreise.", intro: "Die wichtigsten Informationen zur Wohnung, zur Anfrage und zur Bestätigung des Aufenthalts.", q1: "Für wie viele Gäste ist die Wohnung geeignet?", a1: "Die Wohnung ist für maximal 4 Gäste ausgelegt.", q2: "Wie ist die Wohnung aufgeteilt?", a2: "Es gibt zwei Schlafzimmer — eines mit Doppelbett und eines mit zwei Einzelbetten — einen Wohn- und Essbereich, eine kompakte Küche, zwei Badezimmer und einen Balkon.", q3: "Wie wird eine Buchung bestätigt?", a3: "Wählen Sie Daten und Gästezahl und senden Sie eine Anfrage. Der Aufenthalt ist erst nach Annahme durch den Eigentümer bestätigt.", q4: "Blockiert eine Anfrage den Zeitraum?", a4: "Nein. Die Daten werden erst nach Annahme der Anfrage blockiert; vorher bleiben sie für andere Gäste verfügbar.", q5: "Wann erhalte ich die genaue Adresse?", a5: "Die genaue Lage in Falerna Marina und die Anreisehinweise teilen wir nach Bestätigung des Aufenthalts mit.", q6: "Wie kann ich Kontakt aufnehmen?", a6: "Sie können das Anfrageformular nutzen, eine E-Mail senden oder uns über WhatsApp schreiben. Geben Sie am besten Daten und Gästezahl an." },
  ...
  fr: {
    ...
    stay: { kicker: "Votre séjour", title: "Idéal pour une escapade à plusieurs.", text: "L’appartement comprend la climatisation, deux chambres — l’une avec un lit double et l’autre avec deux lits simples — ainsi qu’un espace salon-repas, une cuisine compacte, deux salles de bains — dont une avec douche et lave-linge — et un balcon.", note: "Nous confirmerons les détails des équipements et les conditions du séjour lors de votre demande.", cta: "Voir les disponibilités" },
    ...
    pricing: { title: "Estimation du séjour", selectDates: "Choisissez les dates d’arrivée et de départ pour afficher l’estimation.", nights: "Nuits", accommodation: "Séjour", discount: "Remise long séjour", cleaning: "Préparation de l’appartement", total: "Total indicatif", note: "Cette estimation n’est pas contractuelle. Le propriétaire confirme le prix final, les éventuelles taxes locales et les conditions lors de l’acceptation de la demande." },
    ...
    faq: { kicker: "Questions fréquentes", title: "À savoir avant votre arrivée.", intro: "Les informations essentielles sur l’appartement, la demande et la confirmation du séjour.", q1: "Combien de voyageurs l’appartement peut-il accueillir ?", a1: "L’appartement peut accueillir jusqu’à 4 voyageurs.", q2: "Comment l’appartement est-il agencé ?", a2: "Il comprend deux chambres — une avec un lit double et une avec deux lits simples — un espace salon-repas, une cuisine compacte, deux salles de bains et un balcon.", q3: "Comment la réservation est-elle confirmée ?", a3: "Choisissez les dates et le nombre de voyageurs, puis envoyez une demande. Le séjour n’est confirmé qu’après acceptation par le propriétaire.", q4: "Une demande bloque-t-elle les dates ?", a4: "Non. Les dates sont bloquées uniquement après acceptation de la demande ; avant cela, elles restent disponibles pour d’autres voyageurs.", q5: "Quand recevrai-je l’adresse exacte ?", a5: "Nous transmettons la localisation exacte à Falerna Marina et les indications d’arrivée après confirmation du séjour.", q6: "Comment vous contacter ?", a6: "Vous pouvez utiliser le formulaire, envoyer un e-mail ou écrire sur WhatsApp. Pensez à préciser vos dates et le nombre de voyageurs." },
    ...
    alt: { hero: "Balcon de l’appartement avec vue sur la mer Tyrrhénienne", interior: "Salon et salle à manger avec accès au balcon", sea: "Salle à manger de l’appartement Mare Lento", livingDining: "Salon et salle à manger avec accès au balcon", doubleBedroom: "Chambre double avec accès au balcon", twinBedroom: "Chambre avec deux lits simples", bathroom: "L’une des deux salles de bains de l’appartement, avec cabine de douche et bidet", regionGallery1: "Vue depuis une terrasse sur la côte turquoise de Calabre", regionGallery2: "Vue sur la côte depuis le belvédère de Capo Vaticano", regionGallery3: "Panorama de Pizzo Calabro et de la côte tyrrhénienne turquoise", regionGallery4: "Vagues contre une grotte rocheuse sur la côte calabraise", regionGallery5: "Sanctuaire Santa Maria dell’Isola sur son promontoire rocheux à Tropea" }
  },
  es: {
    ...
    pricing: { title: "Precio estimado de la estancia", selectDates: "Elige las fechas de llegada y salida para ver la estimación.", nights: "Noches", accommodation: "Estancia", discount: "Descuento por estancia larga", cleaning: "Preparación del apartamento", total: "Total estimado", note: "Esta estimación no es vinculante. El propietario confirmará el precio final, los posibles cargos locales y las condiciones al aceptar la consulta." },
    ...
    faq: { kicker: "Preguntas frecuentes", title: "Lo que conviene saber antes de llegar.", intro: "La información esencial sobre el apartamento, la consulta y la confirmación de la estancia.", q1: "¿Para cuántos huéspedes es el apartamento?", a1: "El apartamento tiene capacidad para un máximo de 4 huéspedes.", q2: "¿Cómo se distribuye el apartamento?", a2: "Dispone de dos dormitorios — uno con cama doble y otro con dos camas individuales — zona de estar y comedor, cocina compacta, dos baños y balcón.", q3: "¿Cómo se confirma una reserva?", a3: "Elige las fechas y el número de huéspedes y envía una consulta. La estancia solo queda confirmada cuando el propietario la acepta.", q4: "¿Enviar una consulta bloquea las fechas?", a4: "No. Las fechas se bloquean únicamente después de aceptar la consulta; hasta entonces siguen disponibles para otros huéspedes.", q5: "¿Cuándo recibiré la dirección exacta?", a5: "Compartimos la ubicación exacta en Falerna Marina y las indicaciones de llegada después de confirmar la estancia.", q6: "¿Cómo puedo contactar?", a6: "Puedes utilizar el formulario, enviar un correo electrónico o escribir por WhatsApp. Es útil indicar las fechas y el número de huéspedes." },
...
const priceEmpty = document.querySelector("#price-estimate-empty");
const priceBreakdown = document.querySelector("#price-breakdown");
const priceDiscountRow = document.querySelector("#price-discount-row");
...
function formatMoney(value, currency = "EUR") {
  return new Intl.NumberFormat(translations[language].locale, {
    style: "currency",
    currency,
...
function updatePriceEstimate() {
  const hasCompleteStay = selectedStart && selectedEnd && selectedStart < selectedEnd;
  if (!hasCompleteStay || !pricingRules) {
  ...
  try {
    const estimate = pricingRules.calculateStayPrice(
      dateKey(selectedStart),
      dateKey(selectedEnd),
      Number(guestSelect.value),
      config.PRICING,
    );
    priceTotal.textContent = formatMoney(estimate.total, estimate.currency);
    document.querySelector("#price-nights").textContent = String(estimate.nights);
    document.querySelector("#price-accommodation").textContent = formatMoney(
      estimate.accommodationBeforeDiscount,
      estimate.currency,
    );
    document.querySelector("#price-discount").textContent = `−${formatMoney(estimate.discount, estimate.currency)}`;
    document.querySelector("#price-cleaning").textContent = formatMoney(estimate.cleaningFee, estimate.currency);
    priceDiscountRow.hidden = estimate.discount <= 0;
...
function updateWhatsAppLinks() {
  ...
  const displayPhone = /^48\d{9}$/.test(digits)
  ...
  document.querySelectorAll("[data-contact-phone]").forEach((link) => {
    ...
    if (digits.length >= 8) link.href = `tel:+${digits}`;

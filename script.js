const translations = {
  pl: {
    ...
    gallery: { kicker: "Galeria", title: "Zajrzyj do środka.", description: "Jasne wnętrza, proste detale i widok, który zostaje na dłużej.", livingDining: "Salon i jadalnia", doubleBedroom: "Sypialnia dwuosobowa", twinBedroom: "Sypialnia z dwoma łóżkami", balcony: "Balkon i widok", bathroom: "Łazienka" },
    place: {
  ...
  en: {
    locale: "en-GB", pageTitle: "Holiday apartment in Falerna Marina | KS Rent", pageDescription: "A holiday apartment with a sea view in Falerna Marina, Calabria. Two bedrooms, a balcony and a peaceful base for exploring southern Italy.", skip: "Skip to content", language: { label: "Choose language" }, headerCta: "Enquire about a stay",
    ...
    gallery: { kicker: "Gallery", title: "Take a look inside.", description: "Bright interiors, simple details and a view that stays with you.", livingDining: "Living and dining room", doubleBedroom: "Double bedroom", twinBedroom: "Twin bedroom", balcony: "Balcony and view", bathroom: "Bathroom" },
  ...
  it: {
    locale: "it-IT", pageTitle: "Casa vacanze a Falerna Marina | KS Rent", pageDescription: "Casa vacanze con vista mare a Falerna Marina, Calabria. Due camere da letto, balcone e una base tranquilla per scoprire il sud Italia.", skip: "Vai al contenuto", language: { label: "Scegli la lingua" }, headerCta: "Richiedi un soggiorno",
    ...
    gallery: { kicker: "Galleria", title: "Entra e dai un’occhiata.", description: "Interni luminosi, dettagli semplici e una vista che resta con te.", livingDining: "Soggiorno e sala da pranzo", doubleBedroom: "Camera matrimoniale", twinBedroom: "Camera doppia", balcony: "Balcone e vista", bathroom: "Bagno" },
    ...
    alt: { hero: "Balcone dell’appartamento con vista sul Mar Tirreno", interior: "Soggiorno e sala da pranzo con accesso al balcone", sea: "Sala da pranzo dell’appartamento KS Rent", livingDining: "Soggiorno e sala da pranzo con accesso al balcone", doubleBedroom: "Camera matrimoniale con accesso al balcone", twinBedroom: "Camera con due letti singoli", bathroom: "Bagno con doccia e lavatrice", regionGallery1: "Vista dalla terrazza sulla costa turchese della Calabria", regionGallery2: "Vista sulla costa dal belvedere di Capo Vaticano", regionGallery3: "Panorama di Pizzo Calabro e della costa tirrenica turchese", regionGallery4: "Onde che si infrangono contro una grotta rocciosa sulla costa calabrese", regionGallery5: "Santuario di Santa Maria dell’Isola sul promontorio roccioso di Tropea" }
  },
  de: {
    locale: "de-DE", pageTitle: "Ferienwohnung in Falerna Marina | KS Rent", pageDescription: "Ferienwohnung mit Meerblick in Falerna Marina, Kalabrien. Zwei Schlafzimmer, ein Balkon und ein ruhiger Ausgangspunkt für Süditalien.", skip: "Zum Inhalt springen", language: { label: "Sprache wählen" }, headerCta: "Aufenthalt anfragen",
    nav: { apartment: "Apartment", availability: "Verfügbarkeit", gallery: "Galerie", location: "Umgebung", contact: "Kontakt" },
    hero: { kicker: "Falerna Marina · Kalabrien", title: "Das Meer zum Greifen nah.", description: "Ein ruhiges Apartment für entspannte Tage im Süden.", link: "Den Ort entdecken", caption: "Blick vom Balkon" },
    intro: { kicker: "Italienischer Rhythmus", title: "Hier beginnen die Morgen im Licht und enden mit dem Rauschen des Meeres.", text: "KS Rent ist ein Ort zum Durchatmen in Falerna Marina. Helle Räume, ein Balkon und der Blick auf die Küste bilden einen unkomplizierten Ausgangspunkt für Strandtage, Entdeckungen in Kalabrien und echte Erholung.", link: "Galerie ansehen" },
    ...
    contact: { title: "Sie haben schon einen Zeitraum im Kopf? Schreiben Sie uns.", text: "Wählen Sie Ihre Daten und sagen Sie uns, was Sie benötigen — wir melden uns mit der aktuellen Verfügbarkeit.", emailCta: "Anfrage senden", whatsappCta: "Über WhatsApp schreiben", whatsappUnavailable: "WhatsApp wird aktiviert, sobald die Nummer des Eigentümers hinterlegt ist." },
    ...
    form: { name: "Vor- und Nachname", namePlaceholder: "Ihr Name", email: "E-Mail", arrival: "Von", departure: "Bis", message: "Nachricht", messagePlaceholder: "Erzählen Sie uns kurz von Ihrer Reise.", consent: "Ich stimme zu, dass meine Angaben ausschließlich zur Bearbeitung dieser Aufenthaltsanfrage verwendet werden.", submit: "Anfrage senden", note: "Wir verwenden Ihre Daten ausschließlich zur Beantwortung der Anfrage. Das Absenden bestätigt keine Buchung.", sending: "Anfrage wird gesendet…", success: "Ihre Anfrage wurde an den Eigentümer gesendet. Die Daten bleiben bis zur Bestätigung verfügbar.", notificationIssue: "Ihre Anfrage wurde gespeichert, die E-Mail-Benachrichtigung konnte jedoch nicht versendet werden. Kontaktieren Sie uns bitte zusätzlich über WhatsApp.", missingConfig: "Das Formular muss noch mit Supabase verbunden werden. Nutzen Sie bitte WhatsApp oder versuchen Sie es später erneut.", datesRequired: "Bitte wählen Sie ein gültiges An- und Abreisedatum.", conflict: "Diese Daten sind soeben nicht verfügbar geworden. Bitte wählen Sie einen anderen Zeitraum.", error: "Die Anfrage konnte nicht gesendet werden. Bitte versuchen Sie es gleich noch einmal." },
    whatsapp: { message: "Guten Tag, ich interessiere mich für einen Aufenthalt bei KS Rent{dates}. Anzahl der Gäste: {guests}. Ist der Zeitraum verfügbar?", dates: " vom {from} bis {to}" },
    alt: { hero: "Balkon des Apartments mit Blick auf das Tyrrhenische Meer", interior: "Wohn- und Esszimmer mit Zugang zum Balkon", sea: "Essbereich des KS Rent Apartments", livingDining: "Wohn- und Esszimmer mit Zugang zum Balkon", doubleBedroom: "Doppelzimmer mit Zugang zum Balkon", twinBedroom: "Schlafzimmer mit zwei Einzelbetten", bathroom: "Badezimmer mit Dusche und Waschmaschine", regionGallery1: "Terrassenblick auf die türkisfarbene Küste Kalabriens", regionGallery2: "Küstenblick vom Aussichtspunkt Capo Vaticano", regionGallery3: "Panorama von Pizzo Calabro und der türkisfarbenen tyrrhenischen Küste", regionGallery4: "Wellen an einer felsigen Grotte an der kalabrischen Küste", regionGallery5: "Wallfahrtskirche Santa Maria dell’Isola auf dem Felsvorsprung in Tropea" }
  },
  fr: {
    locale: "fr-FR", pageTitle: "Appartement de vacances à Falerna Marina | KS Rent", pageDescription: "Appartement de vacances avec vue sur mer à Falerna Marina, en Calabre. Deux chambres, un balcon et un point de départ paisible dans le sud de l’Italie.", skip: "Aller au contenu", language: { label: "Choisir la langue" }, headerCta: "Demander un séjour",
    nav: { apartment: "Appartement", availability: "Disponibilités", gallery: "Galerie", location: "Alentours", contact: "Contact" },
    hero: { kicker: "Falerna Marina · Calabre", title: "La mer à portée de main.", description: "Un appartement paisible, pensé pour de douces journées dans le Sud.", link: "Découvrir le lieu", caption: "Vue depuis le balcon" },
    intro: { kicker: "Rythme italien", title: "Ici, les matins commencent dans la lumière et s’achèvent au son de la mer.", text: "KS Rent est une invitation à respirer à Falerna Marina. Des intérieurs lumineux, un balcon et une vue sur la côte composent un pied-à-terre simple pour profiter de la plage, découvrir la Calabre et vraiment se reposer.", link: "Voir la galerie" },
    ...
    booking: { kicker: "Disponibilités", title: "Organisez votre séjour.", text: "Choisissez vos dates et envoyez une demande. La période n’est bloquée qu’après acceptation par le propriétaire.", integrationTitle: "Comment fonctionne la demande", integrationText: "Votre demande est envoyée au propriétaire. Les demandes en attente ne bloquent pas le calendrier — seule leur acceptation réserve les dates.", cardKicker: "Demande de séjour", cardTitle: "Choisissez vos dates", available: "Choisir une date", selected: "Dates sélectionnées", occupied: "Indisponible", checkin: "Arrivée", checkout: "Départ", guests: "Voyageurs", cta: "Continuer la demande", disclaimer: "L’envoi d’une demande ne confirme pas le séjour. Les dates ne sont bloquées qu’après acceptation par le propriétaire.", previousMonth: "Mois précédent", nextMonth: "Mois suivant", loading: "Chargement des disponibilités…", ready: "Le calendrier est à jour.", setup: "Les disponibilités en ligne nécessitent la configuration de Supabase.", error: "Impossible de charger les disponibilités. Veuillez réessayer dans un instant.", conflict: "La période sélectionnée comprend des dates indisponibles. Choisissez d’autres dates.", online: "EN LIGNE", configuration: "CONFIGURATION" },
    gallery: { kicker: "Galerie", title: "Entrez et découvrez les lieux.", description: "Des intérieurs lumineux, des détails simples et une vue qui reste en mémoire.", livingDining: "Salon et salle à manger", doubleBedroom: "Chambre double", twinBedroom: "Chambre à deux lits", balcony: "Balcon et vue", bathroom: "Salle de bains" },
    ...
    form: { name: "Nom et prénom", namePlaceholder: "Votre nom", email: "E-mail", arrival: "Du", departure: "Au", message: "Message", messagePlaceholder: "Parlez-nous brièvement de votre voyage.", consent: "J’accepte que les informations fournies soient utilisées uniquement pour traiter cette demande de séjour.", submit: "Envoyer la demande", note: "Nous utilisons vos données uniquement pour répondre à cette demande. Son envoi ne confirme pas une réservation.", sending: "Envoi de votre demande…", success: "Votre demande a été envoyée au propriétaire. Les dates restent disponibles jusqu’à son acceptation.", notificationIssue: "Votre demande a été enregistrée, mais l’e-mail de notification n’a pas été envoyé. Contactez-nous également sur WhatsApp.", missingConfig: "Le formulaire doit encore être connecté à Supabase. Utilisez WhatsApp ou réessayez plus tard.", datesRequired: "Choisissez des dates d’arrivée et de départ valides.", conflict: "Ces dates viennent de devenir indisponibles. Veuillez choisir une autre période.", error: "Impossible d’envoyer la demande. Veuillez réessayer dans un instant." },
    whatsapp: { message: "Bonjour, je souhaite séjourner chez KS Rent{dates}. Nombre de voyageurs : {guests}. Ces dates sont-elles disponibles ?", dates: " du {from} au {to}" },
    alt: { hero: "Balcon de l’appartement avec vue sur la mer Tyrrhénienne", interior: "Salon et salle à manger avec accès au balcon", sea: "Salle à manger de l’appartement KS Rent", livingDining: "Salon et salle à manger avec accès au balcon", doubleBedroom: "Chambre double avec accès au balcon", twinBedroom: "Chambre avec deux lits simples", bathroom: "Salle de bains avec douche et lave-linge", regionGallery1: "Vue depuis une terrasse sur la côte turquoise de Calabre", regionGallery2: "Vue sur la côte depuis le belvédère de Capo Vaticano", regionGallery3: "Panorama de Pizzo Calabro et de la côte tyrrhénienne turquoise", regionGallery4: "Vagues contre une grotte rocheuse sur la côte calabraise", regionGallery5: "Sanctuaire Santa Maria dell’Isola sur son promontoire rocheux à Tropea" }
  },
  es: {
    locale: "es-ES", pageTitle: "Apartamento vacacional en Falerna Marina | KS Rent", pageDescription: "Apartamento vacacional con vistas al mar en Falerna Marina, Calabria. Dos dormitorios, balcón y una base tranquila para descubrir el sur de Italia.", skip: "Ir al contenido", language: { label: "Elegir idioma" }, headerCta: "Consultar estancia",
    nav: { apartment: "Apartamento", availability: "Disponibilidad", gallery: "Galería", location: "Alrededores", contact: "Contacto" },
    hero: { kicker: "Falerna Marina · Calabria", title: "El mar al alcance de la mano.", description: "Un apartamento tranquilo, pensado para disfrutar sin prisas del sur.", link: "Descubrir el lugar", caption: "Vista desde el balcón" },
    intro: { kicker: "Ritmo italiano", title: "Aquí, las mañanas empiezan con luz y terminan con el sonido del mar.", text: "KS Rent es un lugar para respirar y descansar en Falerna Marina. Sus interiores luminosos, el balcón y las vistas de la costa crean una base sencilla para ir a la playa, descubrir Calabria y desconectar de verdad.", link: "Ver la galería" },
    ...
    contact: { title: "¿Ya tienes unas fechas en mente? Escríbenos.", text: "Elige las fechas y cuéntanos qué necesitas — te responderemos con la disponibilidad.", emailCta: "Enviar consulta", whatsappCta: "Escribir por WhatsApp", whatsappUnavailable: "WhatsApp estará disponible cuando se configure el número del propietario." },

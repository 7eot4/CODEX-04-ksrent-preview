const translations = {
  pl: {
    ...
    stay: { kicker: "Twój pobyt", title: "W sam raz na wspólny wyjazd.", text: "W apartamencie są dwie sypialnie — jedna z łóżkiem podwójnym, druga z dwoma pojedynczymi łóżkami — a także część dzienna z jadalnią, kompaktowa kuchnia, łazienka z prysznicem i pralką oraz balkon.", note: "Szczegóły wyposażenia i warunków pobytu potwierdzimy przy zapytaniu.", cta: "Sprawdź dostępność" },
    booking: {
    ...
    gallery: { kicker: "Galeria", title: "Zajrzyj do środka.", description: "Zdjęcia są ułożone zgodnie z pomieszczeniami apartamentu.", livingDining: "Salon i jadalnia", doubleBedroom: "Sypialnia dwuosobowa", twinBedroom: "Sypialnia z dwoma łóżkami", balcony: "Balkon i widok", kitchen: "Kuchnia", bathroom: "Łazienka" },
    place: {
      title: "Kalabria, w której nie trzeba się spieszyć.", text: "Zacznij od plaży i zachodu słońca, a na dłuższy dzień wybierz Pizzo, Tropeę albo Capo Vaticano. Falerna Marina jest spokojną bazą do odkrywania wybrzeża Morza Tyrreńskiego.", note: "Dokładną lokalizację i wskazówki dojazdu przekazujemy po potwierdzeniu pobytu.",

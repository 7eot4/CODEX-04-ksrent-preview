const translations = {
  pl: {
    ...
    gallery: { kicker: "Galeria", title: "Zajrzyj do środka.", livingDining: "Salon i jadalnia", doubleBedroom: "Sypialnia dwuosobowa", twinBedroom: "Sypialnia z dwoma łóżkami", balcony: "Balkon i widok", bathroom: "Łazienka" },
    place: {
  ...
  en: {
    ...
    gallery: { kicker: "Gallery", title: "Take a look inside.", livingDining: "Living and dining room", doubleBedroom: "Double bedroom", twinBedroom: "Twin bedroom", balcony: "Balcony and view", bathroom: "Bathroom" },
  ...
  it: {
    ...
    gallery: { kicker: "Galleria", title: "Entra e dai un’occhiata.", livingDining: "Soggiorno e sala da pranzo", doubleBedroom: "Camera matrimoniale", twinBedroom: "Camera doppia", balcony: "Balcone e vista", bathroom: "Bagno" },
